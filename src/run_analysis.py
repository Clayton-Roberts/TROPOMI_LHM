...
end_datetime   = datetime.strptime('2019-12-31', '%Y-%m-%d')
...
## TODO put bit in here about dropout_dataset.csv being made, remaining_dataset.csv, summary.csv
...
#fit_model.data_rich(date_range, 'averaged', dropout=True)
...
# print('This may take some time, please be patient.\n')
# fit_model.data_rich(date_range, 'averaged', dropout=False)
# print('\nCreated the following files:\n')
...
#print('This may take some time, please be patient.\n')
#fit_model.data_poor(date_range, dropout=True)
#print('Created the following files:\n')
#print('    [1] outputs/' + date_range + '-data_poor/dropout/summary.txt')
#print('    [2] outputs/' + date_range + '-data_poor/dropout/summary.csv')
#print('    [3] outputs/' + date_range + '-data_poor/dropout/ess.csv')
#print('\n=========================================================\n')
...
# print('This may take some time, please be patient.\n')
# fit_model.data_rich('20190101-20190131', 'averaged', dropout=False)
# print('Created the following files:\n')
...
# print('This may take some time, please be patient.\n')
# fit_model.data_rich('20190101-20190131', 'individual', dropout=False)
# print('Created the following files:\n')
...
# print('\n=========================================================\n')
# --------------------------------------------------
#print('Calculating comparison with Bremen...')
#tropomi_processing.compare_with_bremen("2019-01-01", "2019-07-11")
...
# plotting.figure_2(fitted_results, '2019-01-31')
# plotting.figure_3(date_range)
...
#
# print('\nResiduals between ERA5 and TROPOMI dry air column densities have mean {:.2f} kg/m\u00b2'.format(dacd_mean) +
#       '\nwith standard deviation {:.2f} kg/m\u00b2'.format(dacd_stddev) + ' and RMSD of {:.2f} kg/m\u00b2.\n'.format(dacd_rmsd))
#
# data_rich_metrics_df = pd.read_csv(constants.FILE_PREFIX + '/outputs/' + date_range + '-data_rich/summary.csv')
# data_poor_metrics_df = pd.read_csv(constants.FILE_PREFIX + '/outputs/' + date_range + '-data_poor/summary.csv')
#
# data_rich_ess = np.min(data_rich_metrics_df.N_Eff)
# data_poor_ess = np.min(data_poor_metrics_df.N_Eff)
#
# print('The data-rich model had an ESS of {} and the data-poor model had an ESS of {}.\n'.format(data_rich_ess, data_poor_ess))
plotting.bremen_comparison()
